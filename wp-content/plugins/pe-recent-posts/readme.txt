...
18. Ordering type (date, title, most commented, most read).
19. Navigation (bullets, none).
20. Description limit - enter number of chars for each slide description.
21. Image alignment (left, right, top, bottom).
22. Show/hide thumbnail.
23. Thumbnail linkable - link the image to the full post
