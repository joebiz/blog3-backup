...
class N2GeneratorWooCommerceProductsByFilter extends N2GeneratorAbstract {
    ...
    public function renderFields($form) {
        ...
        new N2ElementText($timestamps, 'timestampvariables', n2_('Replace these timestamp variables'), '', array(
            'tip' => n2_('Separate them with comma.')
        ));
        new N2ElementText($timestamps, 'timestampformat', n2_('Date format'), 'm-d-Y', array(
